...
GITEA_SMTP_FROM=${GITEA_SMTP_FROM:-gitea@localhost.localdomain}
...
GITEA_ROOT_EMAIL=${GITEA_ROOT_EMAIL:-root@localhost.localdomain}
...
if [ -f /etc/gitea/app.ini ]; then
  ...
  export GITEA_SMTP_ENABLE GITEA_SMTP_HOST GITEA_SMTP_FROM GITEA_SMTP_USER GITEA_SMTP_PASS
  export GITEA_RECAPTCHA_ENABLE GITEA_RECAPTCHA_SECRET GITEA_RECAPTCHA_KEY
